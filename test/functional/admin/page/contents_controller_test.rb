...
class AdminPageContentsControllerTest < ActionController::TestCase
  tests Admin::Page::ContentsController
  ...
  test "anonymous user redirected to login for index" do
    ...
    assert_redirected_to login_url(return_to: admin_page_contents_url(section))
  end
end
