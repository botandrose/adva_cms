...
class AdminPageCategoriesControllerTest < ActionController::TestCase
  tests Admin::Page::CategoriesController
  ...
  test "anonymous user redirected to login for index" do
    ...
    assert_redirected_to login_url(return_to: admin_page_categories_url(section))
  end
end
