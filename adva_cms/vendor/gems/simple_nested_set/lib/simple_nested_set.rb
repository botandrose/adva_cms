  ...
  module NestedSet
    module ActMacro
      def acts_as_nested_set(options = {})
        ...
        scope :nested_set, lambda { |s| { :conditions => conditions.call(s) } } do
    ...
    module InstanceMethods
      ...
      def move_by_attributes(attrs)
        ...
        unless attrs.has_key?(:parent_id) && attrs[:parent_id].blank?
        ...
        if attrs.has_key?(:left_id) && attrs[:left_id].blank?
          ...
          siblings = parent ? parent.children : self.class.base_class.roots(self)
